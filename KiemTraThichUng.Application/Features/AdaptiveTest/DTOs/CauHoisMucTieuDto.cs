// File: KiemTraThichUng.Application/Features/AdaptiveTest/DTOs/CauHoisDto.cs
using KiemTraThichUng.Domain.Enums;

namespace KiemTraThichUng.Application.Features.AdaptiveTest.DTOs
{
    public class CauHoisMucTieuDto
    {
        ...
        public double? DoPhanLoai { get; set; }
        ...
        public IEnumerable<CauTraLoisMucTieuDto>? CauTraLois { get; set; }
    }
}
